#include <sdp.h>
bool sdp::decode_sdp_D_PERF_WDMA_WRITE_STALL_group0() {
sc_biguint<22> local_var_1 = 45280;
...
void sdp::update_sdp_D_PERF_WDMA_WRITE_STALL_group0() {
auto local_var_1 = sdp_csb_data.range(31, 0);
auto local_var_1_nxt_holder = local_var_1;
sdp_group0_d_wdma_stall = local_var_1_nxt_holder;
#ifdef ILATOR_VERBOSE
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "D_PERF_WDMA_WRITE_STALL_group0 state updates:" << std::endl;
instr_update_log << "    sdp_group0_d_wdma_stall => " << std::hex << "0x" << sdp_group0_d_wdma_stall << std::endl; 
