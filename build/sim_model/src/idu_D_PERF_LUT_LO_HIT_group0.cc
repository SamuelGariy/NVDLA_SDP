#include <sdp.h>
bool sdp::decode_sdp_D_PERF_LUT_LO_HIT_group0() {
sc_biguint<22> local_var_1 = 45304;
...
auto& univ_var_97 = local_var_24;
return univ_var_97;
}
void sdp::update_sdp_D_PERF_LUT_LO_HIT_group0() {
auto local_var_1 = sdp_csb_data.range(31, 0);
auto local_var_1_nxt_holder = local_var_1;
sdp_group0_d_lut_lo_hit = local_var_1_nxt_holder;
#ifdef ILATOR_VERBOSE
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "D_PERF_LUT_LO_HIT_group0 state updates:" << std::endl;
instr_update_log << "    sdp_group0_d_lut_lo_hit => " << std::hex << "0x" << sdp_group0_d_lut_lo_hit << std::endl; 
