#include <sdp.h>
bool sdp::decode_sdp_D_PERF_WDMA_WRITE_STALL_group1() {
...
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "D_PERF_WDMA_WRITE_STALL_group1 state updates:" << std::endl;
instr_update_log << "    sdp_group1_d_wdma_stall => " << std::hex << "0x" << sdp_group1_d_wdma_stall << std::endl; 
