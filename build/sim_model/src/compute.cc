...
if (valid_sdp() && decode_sdp_D_STATUS_group0()) {
#ifdef ILATOR_PROFILING
  auto start = std::chrono::high_resolution_clock::now();
#endif
  update_sdp_D_STATUS_group0();
  
#ifdef ILATOR_PROFILING
  auto stop = std::chrono::high_resolution_clock::now();
  auto exec_time = std::chrono::duration_cast<std::chrono::nanoseconds>(stop-start).count();
  LogInstrSequence("D_STATUS_group0", exec_time);
#endif
}
if (valid_sdp() && decode_sdp_D_STATUS_group1()) {
#ifdef ILATOR_PROFILING
  auto start = std::chrono::high_resolution_clock::now();
#endif
  update_sdp_D_STATUS_group1();
  
#ifdef ILATOR_PROFILING
  auto stop = std::chrono::high_resolution_clock::now();
  auto exec_time = std::chrono::duration_cast<std::chrono::nanoseconds>(stop-start).count();
  LogInstrSequence("D_STATUS_group1", exec_time);
#endif
}
if (valid_sdp() && decode_sdp_D_STATUS_NAN_INPUT_NUM_group0()) {
#ifdef ILATOR_PROFILING
  auto start = std::chrono::high_resolution_clock::now();
#endif
  update_sdp_D_STATUS_NAN_INPUT_NUM_group0();
  
#ifdef ILATOR_PROFILING
  auto stop = std::chrono::high_resolution_clock::now();
  auto exec_time = std::chrono::duration_cast<std::chrono::nanoseconds>(stop-start).count();
  LogInstrSequence("D_STATUS_NAN_INPUT_NUM_group0", exec_time);
#endif
}
if (valid_sdp() && decode_sdp_D_STATUS_NAN_INPUT_NUM_group1()) {
#ifdef ILATOR_PROFILING
  auto start = std::chrono::high_resolution_clock::now();
#endif
  update_sdp_D_STATUS_NAN_INPUT_NUM_group1();
  
#ifdef ILATOR_PROFILING
  auto stop = std::chrono::high_resolution_clock::now();
  auto exec_time = std::chrono::duration_cast<std::chrono::nanoseconds>(stop-start).count();
  LogInstrSequence("D_STATUS_NAN_INPUT_NUM_group1", exec_time);
#endif
}
if (valid_sdp() && decode_sdp_D_STATUS_INF_INPUT_NUM_group0()) {
#ifdef ILATOR_PROFILING
  auto start = std::chrono::high_resolution_clock::now();
#endif
  update_sdp_D_STATUS_INF_INPUT_NUM_group0();
  
#ifdef ILATOR_PROFILING
  auto stop = std::chrono::high_resolution_clock::now();
  auto exec_time = std::chrono::duration_cast<std::chrono::nanoseconds>(stop-start).count();
  LogInstrSequence("D_STATUS_INF_INPUT_NUM_group0", exec_time);
#endif
}
if (valid_sdp() && decode_sdp_D_STATUS_INF_INPUT_NUM_group1()) {
#ifdef ILATOR_PROFILING
  auto start = std::chrono::high_resolution_clock::now();
#endif
  update_sdp_D_STATUS_INF_INPUT_NUM_group1();
  
#ifdef ILATOR_PROFILING
  auto stop = std::chrono::high_resolution_clock::now();
  auto exec_time = std::chrono::duration_cast<std::chrono::nanoseconds>(stop-start).count();
  LogInstrSequence("D_STATUS_INF_INPUT_NUM_group1", exec_time);
#endif
}
if (valid_sdp() && decode_sdp_D_STATUS_NAN_OUTPUT_NUM_group0()) {
#ifdef ILATOR_PROFILING
  auto start = std::chrono::high_resolution_clock::now();
#endif
  update_sdp_D_STATUS_NAN_OUTPUT_NUM_group0();
  
#ifdef ILATOR_PROFILING
  auto stop = std::chrono::high_resolution_clock::now();
  auto exec_time = std::chrono::duration_cast<std::chrono::nanoseconds>(stop-start).count();
  LogInstrSequence("D_STATUS_NAN_OUTPUT_NUM_group0", exec_time);
#endif
}
if (valid_sdp() && decode_sdp_D_STATUS_NAN_OUTPUT_NUM_group1()) {
#ifdef ILATOR_PROFILING
  auto start = std::chrono::high_resolution_clock::now();
#endif
  update_sdp_D_STATUS_NAN_OUTPUT_NUM_group1();
  
#ifdef ILATOR_PROFILING
  auto stop = std::chrono::high_resolution_clock::now();
  auto exec_time = std::chrono::duration_cast<std::chrono::nanoseconds>(stop-start).count();
  LogInstrSequence("D_STATUS_NAN_OUTPUT_NUM_group1", exec_time);
#endif
}
...
if (valid_sdp() && decode_sdp_D_PERF_WDMA_WRITE_STALL_group0()) {
#ifdef ILATOR_PROFILING
  auto start = std::chrono::high_resolution_clock::now();
#endif
  update_sdp_D_PERF_WDMA_WRITE_STALL_group0();
  
#ifdef ILATOR_PROFILING
  auto stop = std::chrono::high_resolution_clock::now();
  auto exec_time = std::chrono::duration_cast<std::chrono::nanoseconds>(stop-start).count();
  LogInstrSequence("D_PERF_WDMA_WRITE_STALL_group0", exec_time);
#endif
}
if (valid_sdp() && decode_sdp_D_PERF_WDMA_WRITE_STALL_group1()) {
#ifdef ILATOR_PROFILING
  auto start = std::chrono::high_resolution_clock::now();
#endif
  update_sdp_D_PERF_WDMA_WRITE_STALL_group1();
  
#ifdef ILATOR_PROFILING
  auto stop = std::chrono::high_resolution_clock::now();
  auto exec_time = std::chrono::duration_cast<std::chrono::nanoseconds>(stop-start).count();
  LogInstrSequence("D_PERF_WDMA_WRITE_STALL_group1", exec_time);
#endif
}
if (valid_sdp() && decode_sdp_D_PERF_LUT_UFLOW_group0()) {
#ifdef ILATOR_PROFILING
  auto start = std::chrono::high_resolution_clock::now();
#endif
  update_sdp_D_PERF_LUT_UFLOW_group0();
  
#ifdef ILATOR_PROFILING
  auto stop = std::chrono::high_resolution_clock::now();
  auto exec_time = std::chrono::duration_cast<std::chrono::nanoseconds>(stop-start).count();
  LogInstrSequence("D_PERF_LUT_UFLOW_group0", exec_time);
#endif
}
if (valid_sdp() && decode_sdp_D_PERF_LUT_UFLOW_group1()) {
#ifdef ILATOR_PROFILING
  auto start = std::chrono::high_resolution_clock::now();
#endif
  update_sdp_D_PERF_LUT_UFLOW_group1();
  
#ifdef ILATOR_PROFILING
  auto stop = std::chrono::high_resolution_clock::now();
  auto exec_time = std::chrono::duration_cast<std::chrono::nanoseconds>(stop-start).count();
  LogInstrSequence("D_PERF_LUT_UFLOW_group1", exec_time);
#endif
}
if (valid_sdp() && decode_sdp_D_PERF_LUT_OFLOW_group0()) {
#ifdef ILATOR_PROFILING
  auto start = std::chrono::high_resolution_clock::now();
#endif
  update_sdp_D_PERF_LUT_OFLOW_group0();
  
#ifdef ILATOR_PROFILING
  auto stop = std::chrono::high_resolution_clock::now();
  auto exec_time = std::chrono::duration_cast<std::chrono::nanoseconds>(stop-start).count();
  LogInstrSequence("D_PERF_LUT_OFLOW_group0", exec_time);
#endif
}
if (valid_sdp() && decode_sdp_D_PERF_LUT_OFLOW_group1()) {
#ifdef ILATOR_PROFILING
  auto start = std::chrono::high_resolution_clock::now();
#endif
  update_sdp_D_PERF_LUT_OFLOW_group1();
  
#ifdef ILATOR_PROFILING
  auto stop = std::chrono::high_resolution_clock::now();
  auto exec_time = std::chrono::duration_cast<std::chrono::nanoseconds>(stop-start).count();
  LogInstrSequence("D_PERF_LUT_OFLOW_group1", exec_time);
#endif
}
if (valid_sdp() && decode_sdp_D_PERF_OUT_SATURATION_group0()) {
#ifdef ILATOR_PROFILING
  auto start = std::chrono::high_resolution_clock::now();
#endif
  update_sdp_D_PERF_OUT_SATURATION_group0();
  
#ifdef ILATOR_PROFILING
  auto stop = std::chrono::high_resolution_clock::now();
  auto exec_time = std::chrono::duration_cast<std::chrono::nanoseconds>(stop-start).count();
  LogInstrSequence("D_PERF_OUT_SATURATION_group0", exec_time);
#endif
}
if (valid_sdp() && decode_sdp_D_PERF_OUT_SATURATION_group1()) {
#ifdef ILATOR_PROFILING
  auto start = std::chrono::high_resolution_clock::now();
#endif
  update_sdp_D_PERF_OUT_SATURATION_group1();
  
#ifdef ILATOR_PROFILING
  auto stop = std::chrono::high_resolution_clock::now();
  auto exec_time = std::chrono::duration_cast<std::chrono::nanoseconds>(stop-start).count();
  LogInstrSequence("D_PERF_OUT_SATURATION_group1", exec_time);
#endif
}
if (valid_sdp() && decode_sdp_D_PERF_LUT_HYBRID_group0()) {
#ifdef ILATOR_PROFILING
  auto start = std::chrono::high_resolution_clock::now();
#endif
  update_sdp_D_PERF_LUT_HYBRID_group0();
  
#ifdef ILATOR_PROFILING
  auto stop = std::chrono::high_resolution_clock::now();
  auto exec_time = std::chrono::duration_cast<std::chrono::nanoseconds>(stop-start).count();
  LogInstrSequence("D_PERF_LUT_HYBRID_group0", exec_time);
#endif
}
if (valid_sdp() && decode_sdp_D_PERF_LUT_HYBRID_group1()) {
#ifdef ILATOR_PROFILING
  auto start = std::chrono::high_resolution_clock::now();
#endif
  update_sdp_D_PERF_LUT_HYBRID_group1();
  
#ifdef ILATOR_PROFILING
  auto stop = std::chrono::high_resolution_clock::now();
  auto exec_time = std::chrono::duration_cast<std::chrono::nanoseconds>(stop-start).count();
  LogInstrSequence("D_PERF_LUT_HYBRID_group1", exec_time);
#endif
}
if (valid_sdp() && decode_sdp_D_PERF_LUT_LE_HIT_group0()) {
#ifdef ILATOR_PROFILING
  auto start = std::chrono::high_resolution_clock::now();
#endif
  update_sdp_D_PERF_LUT_LE_HIT_group0();
  
#ifdef ILATOR_PROFILING
  auto stop = std::chrono::high_resolution_clock::now();
  auto exec_time = std::chrono::duration_cast<std::chrono::nanoseconds>(stop-start).count();
  LogInstrSequence("D_PERF_LUT_LE_HIT_group0", exec_time);
#endif
}
if (valid_sdp() && decode_sdp_D_PERF_LUT_LE_HIT_group1()) {
#ifdef ILATOR_PROFILING
  auto start = std::chrono::high_resolution_clock::now();
#endif
  update_sdp_D_PERF_LUT_LE_HIT_group1();
  
#ifdef ILATOR_PROFILING
  auto stop = std::chrono::high_resolution_clock::now();
  auto exec_time = std::chrono::duration_cast<std::chrono::nanoseconds>(stop-start).count();
  LogInstrSequence("D_PERF_LUT_LE_HIT_group1", exec_time);
#endif
}
if (valid_sdp() && decode_sdp_D_PERF_LUT_LO_HIT_group0()) {
#ifdef ILATOR_PROFILING
  auto start = std::chrono::high_resolution_clock::now();
#endif
  update_sdp_D_PERF_LUT_LO_HIT_group0();
  
#ifdef ILATOR_PROFILING
  auto stop = std::chrono::high_resolution_clock::now();
  auto exec_time = std::chrono::duration_cast<std::chrono::nanoseconds>(stop-start).count();
  LogInstrSequence("D_PERF_LUT_LO_HIT_group0", exec_time);
#endif
}
if (valid_sdp() && decode_sdp_D_PERF_LUT_LO_HIT_group1()) {
#ifdef ILATOR_PROFILING
  auto start = std::chrono::high_resolution_clock::now();
#endif
  update_sdp_D_PERF_LUT_LO_HIT_group1();
  
#ifdef ILATOR_PROFILING
  auto stop = std::chrono::high_resolution_clock::now();
  auto exec_time = std::chrono::duration_cast<std::chrono::nanoseconds>(stop-start).count();
  LogInstrSequence("D_PERF_LUT_LO_HIT_group1", exec_time);
#endif
}
